...
cv2.imwrite('selfie-kfilt-gaus1.jpg', filt1)
cv2.imwrite('selfie-kfilt-gaus2.jpg', filt2)
#cv2.imwrite('selfie-kfilt-gaus.jpg', (cv2.cvtColor(filt, cv2.COLOR_Lab2BGR) * 255).astype('uint8'))
